                ...
                <div class="page-single">
                    ...
                    <div class="page-content">
                        ...
                        <div class="project-inner-box">
                            ...
                            <div class="row gy-4 align-items-center">
                                <div class="col-md-6"><img class="w-100 rounded-3" src="assets/img/project/project_inner_2.jpg" alt="project"></div>
                                <div class="col-md-6"><img class="w-100 rounded-3" src="assets/img/project/project_inner_3.jpg" alt="project"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-4 col-lg-4">
                <aside class="sidebar-area">
                        ...
                        <div class="project-info-list">
                            <div class="contact-feature">
                                ...
                                <div class="media-body">
                                    <p class="contact-feature_label">Clients:</p><a href="https://www.trustpilot.com/" class="contact-feature_link">David Jackson</a>
                                </div>
                            </div>
                            <div class="contact-feature">
                                <div class="icon-btn"><i class="fa-solid fa-folder-open"></i></div>
                                <div class="media-body">
                                    <p class="contact-feature_label">Category:</p><a href="project.php" class="contact-feature_link">IT Technology</a>
                                </div>
                            </div>
                            <div class="contact-feature">
                                <div class="icon-btn"><i class="fa-solid fa-calendar-days"></i></div>
                                <div class="media-body">
                                    <p class="contact-feature_label">Date</p><span class="contact-feature_link">20 Sep, 2024</span>
                                </div>
                            </div>
                            <div class="contact-feature">
                                <div class="icon-btn"><i class="fa-solid fa-location-dot"></i></div>
                                <div class="media-body">
                                    <p class="contact-feature_label">Address:</p><a href="project.php" class="contact-feature_link">55 Main Address, USA</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="widget widget_download">
                        ...
                        <div class="download-widget-wrap"><a href="service-details.php" class="th-btn"><i class="fa-light fa-file-pdf me-2"></i>DOWNLOAD PDF</a> <a href="service-details.php" class="th-btn style5"><i class="fa-light fa-file-lines me-2"></i>DOWNLOAD DOC</a></div>
                    </div>
                    <div class="widget widget_banner" data-bg-src="assets/img/bg/widget_banner.jpg">
                        <div class="widget-banner"><span class="text">CONTACT US NOW</span>
                            <h2 class="title">You Need Help?</h2><a href="contact.php" class="th-btn style3">GET A QUOTE<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </aside>
            </div>
...
<!-- Mirrored from html.themehour.net/webteck/demo/project-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Nov 2025 13:10:33 GMT -->
