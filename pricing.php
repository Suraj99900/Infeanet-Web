...
<section class="space">
    <div class="container">
        <div class="title-area text-center"><span class="sub-title">
                <div class="icon-masking me-2"><span class="mask-icon" data-mask-src="assets/img/theme-img/title_shape_2.svg"></span> <img src="assets/img/theme-img/title_shape_2.svg" alt="shape"></div>OUR PRICING
            </span>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="price-card">
                    ...
                    <div class="price-card_content">
                        ...
                        </div><a href="pricing.php" class="th-btn">PURCHASE NOW<i class="fa-regular fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
    ...
    <div class="container z-index-common">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-7 col-md-9 text-center">
                ...
                </div><a href="contact.php" class="th-btn style3">Get In Touch</a>
            </div>
        </div>
    </div>
</section>
...
<!-- Mirrored from html.themehour.net/webteck/demo/pricing.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Nov 2025 13:10:36 GMT -->
