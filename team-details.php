...
<section class="space">
    <div class="container">
        <div class="about-card">
            <div class="about-card_img"><img class="w-100" src="assets/img/team/team_details.jpg" alt="team image">
            </div>
            <div class="about-card_box">
                <div class="about-card_top">
                    ...
                    <div class="header-social"><a target="_blank" href="https://facebook.com/"><i
                ...
                <p class="about-card_text">Continually utilize 24/365 bandwidth before real-time interfaces.
                    Credibly grow team core competencies with pandemic commerce. Objectively initiate pandemic users
                    with deliver bricks clicks meta services for bricks-and-clicks innovation streamline front end
                    aradigms expedite granular human capital rather than intuitive testing.</p>
                <div class="team-info-wrap">
                    <div class="contact-feature">
                        <div class="icon-btn"><i class="fa-solid fa-user"></i></div>
                        <div class="media-body">
                            <p class="contact-feature_label">Experience</p><span class="contact-feature_link">More
                                Than 10 Yearsn</span>
                        </div>
                    </div>
                    <div class="contact-feature">
                        ...
                        <div class="media-body">
                            <p class="contact-feature_label">Phone</p><a href="tel:+19088006987"
                                class="contact-feature_link">+(190)-8800-6987</a>
                        </div>
                    </div>
                    <div class="contact-feature">
                        <div class="icon-btn"><i class="fa-solid fa-envelope"></i></div>
                        <div class="media-body">
                            <p class="contact-feature_label">Email</p><a href="mailto:info@webteck.com"
                    ...
                    <div class="contact-feature">
                        ...
                        <div class="media-body">
                            <p class="contact-feature_label">Fax</p><span
                                class="contact-feature_link">+265478962</span>
                        </div>
                    </div>
                </div><a href="about.html" class="th-btn">GET IN TOUCH<i
        ...
        <div class="row mt-5 pt-10">
            <div class="col-xl-6 mb-xl-0">
                ...
                <p class="mb-40">Conveniently innovate professional initiatives whereas virtual information.
                    Compellingly network resource maximizing materials without premier benefits. Phosfluorescently
                    synthesize wireless solutions with robust e-business. Monotonectally implement functionalized
                    ideas with technically sound process improvements. Dramatically disseminate vertical systems
                    after.</p>
                <h5 class="border-title">Professional Skills</h5>
                <p class="mb-40">Credibly scale plug-and-play customer service after high-payoff idea. Monotonectall
                    incentivize installed base intellectual capital whereas flexible process improvement.
                    Conveniently. Distinctively negotiate front-end customer service rather. Process tonectall
                    incentivize installed base intellectual flexible.</p>
            ...
            <div class="col-xl-6 mt-5 mt-xl-0">
                ...
                <p class="mb-20">Energistically myocardinate parallel market with co effective channel. Competently
                    e-enable proactive relationships with stand-alone infomediaries.</p>
...
<!-- Mirrored from html.themehour.net/webteck/demo/team-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Nov 2025 13:10:32 GMT -->
